...
class SokuonKatakana : AppCompatActivity()  {
      ...
      override fun onCreate(savedInstanceState: Bundle?) {
          ...
          sessionTitle.text = "Sokuon Di Katakana"
          ...
          val hiraganaList = JsonLoader.loadHiragana(this, "sokuon_katakana.json")
