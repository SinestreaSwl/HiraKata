...
class DakutenKatakana : AppCompatActivity() {
      ...
      override fun onCreate(savedInstanceState: Bundle?) {
          ...
          sessionTitle.text = "Dakuten & Handakuten Katakana"
          ...
          val hiraganaList = JsonLoader.loadHiragana(this, "dakuten_handakuten_katakana.json")
